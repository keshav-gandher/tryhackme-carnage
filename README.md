...
we can see in that there is a file downloaded. Looking at packet we can see the destination ip. now we can search for ip in display filter with an http filter to see the first contact  with ip. 
